...
public partial class WebsiteKinhDoanhThucPhamChayAnPhucContext : DbContext
{
    public WebsiteKinhDoanhThucPhamChayAnPhucContext()
    {
    }

    public WebsiteKinhDoanhThucPhamChayAnPhucContext(DbContextOptions<WebsiteKinhDoanhThucPhamChayAnPhucContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=WebsiteKinhDoanhThucPhamChayAnPhuc;Trusted_Connection=True;TrustServerCertificate=\ntrue;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blog>(entity =>
        {
            entity.HasKey(e => e.IdBlog).HasName("PK__BLOG__755193260E2D7820");
        ...
        {
            entity.HasKey(e => e.IdCart).HasName("PK__CART__7A1680A5230AF957");
        ...
        {
            entity.HasKey(e => e.IdCd).HasName("PK__CART_DET__8B622F8FA5077A0F");
        ...
        {
            entity.HasKey(e => e.IdCat).HasName("PK__CATOLOGY__2BF8FA1CF0774B2C");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__MENU__4728FC60D21F7AF5");
        ...
        {
            entity.HasKey(e => e.IdPro).HasName("PK__PRODUCTS__20AF98FD4F8A8992");
        ...
        {
            entity.HasKey(e => e.IdSlide).HasName("PK__SLIDER__22D1BB107705B126");
        ...
        {
            entity.HasKey(e => e.IdUsers).HasName("PK__USERS__1DDB35C3C591BA75");
